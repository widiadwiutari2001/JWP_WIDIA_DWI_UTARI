...
// jika di temukan sisi melalui metode post maka akan di proses
if (isset($_POST['sisi'])) {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 border border-info">
                <h3 class=" mt-lg-1 pt-lg-3 pr-5 text-center">Menghitung Luas Persegi</h3>
                <hr>
                <div class="row">
                    <div class="col-md-8">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4>Mari Menghitung Luas Persegi</h4>
                            </div>
                            <div class="card-body">
                                <form action="persegi.php" method="POST">
                                    <div class="form-group">
                                        <label for="sisi">Masukkan Nilai</label>
                                        <input type="number" name="sisi" id="sisi" class="form-control" placeholder="Masukkan Nilai" required>
                                    </div>
